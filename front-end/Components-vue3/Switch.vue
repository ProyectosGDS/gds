...
<template>
    <label class="relative cursor-pointer block aspect-[1.6/0.75] rounded-full transition-all duration-500">
        ...
        <div class="absolute right-[6%] top-1/2 aspect-square h-[70%] -translate-y-1/2  rounded-full bg-white transition-all duration-500 peer-checked/input:right-[57%] "></div>
    </label>
</template>
