...
<template>
    <section class="px-7">
        ...
        <div class="md:flex md:items-center md:justify-between">
            <div class="text-violet-400 bg-white flex items-center px-2 py-1.5">
                <span>Mostrar</span>
                <select v-model="rowsPerPage" @change="resetPage"class="text-center bg-white w-full focus:outline-none ring-0">
                    <option>5</option>
                    <option>10</option>
                    <option>25</option>
                    <option>50</option>
            ...
            <div class="flex items-center gap-1">
                ...
                <div class="flex gap-1">
                    ...
                    <div class="relative" ref="target">
                        <Tool-Tip message="Filtro avanzado" class="-mt-7 text-gray-500" v-if="props.filterAdvance">
                ...
                <table class="w-full">
                    <tr v-for="head in props.headers" class="hover:bg-violet-200">
                        <td class="px-4 font-semibold uppercase text-sm select-none" :width="head.width" align="left" :hidden="head.hidden">
                            <p class="text-violet-400">{{ head.title }}</p>
                        </td>
                        <td align="center" :width="head.width" :hidden="head.hidden">
        ...
        <Tabla class="hidden lg:block">
            ...
            <template #tbody class="bg-white divide-y divide-gray-200">
                <slot name="tbody" :items="paginatedData">
                    <tr v-for="item in paginatedData" :key="item.id" class="hover:bg-gray-50 text-gray-800 select-none">
